/** Lucide-style inline SVG icons. Sized via the parent's font-size + color via currentColor. */

type IconProps = { className?: string; size?: number };

const wrap = (className?: string, size = 16) => ({
  width: size,
  height: size,
  viewBox: "0 0 24 24",
  fill: "none",
...
export function Refresh({ className, size }: IconProps) {
  return (
    <svg {...wrap(className, size)}>
...
export function UploadCloud({ className, size }: IconProps) {
  return (
    <svg {...wrap(className, size)}>
...
export function KeyRound({ className, size }: IconProps) {
  return (
    <svg {...wrap(className, size)}>
...
export function Trash({ className, size }: IconProps) {
  return (
    <svg {...wrap(className, size)}>
      <path d="M3 6h18" />
...
export function Play({ className, size }: IconProps) {
  return (
    <svg {...wrap(className, size)}>
